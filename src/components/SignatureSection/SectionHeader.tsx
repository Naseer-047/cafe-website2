  ...
  return (
    <div className="flex flex-col items-center justify-center text-center w-full z-10 relative mb-16 lg:mb-20">
      ...
      <motion.h2 
        ...
        className="font-bebas text-[clamp(60px,10vw,120px)] leading-[0.9] tracking-[-3px] uppercase flex flex-wrap justify-center gap-x-4 gap-y-0 mb-6"
      >
        <span className="text-premium-distressed-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)]">SIGNATURE</span>
        <span className="text-premium-distressed-yellow drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)]">PICKS</span>
      </motion.h2>

      {/* Subtitle */}
      <motion.p 
        variants={itemVariants}
        className="font-inter text-[rgba(255,255,255,0.75)] text-[clamp(18px,3vw,30px)] leading-relaxed max-w-[700px]"
      >
        Handpicked favorites. Loved by thousands. Made to perfection.
      </motion.p>
    </div>
  );
}
